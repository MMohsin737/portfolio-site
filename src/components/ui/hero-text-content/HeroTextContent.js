...
const HeroTextConent = () => {
  return (
    <div>
      <h1
        className={`xl:text-5xl lg:text-4xl md:text-4xl text-5xl text-white font-light
      ...
      <h3
        className={`xl:text-2xl lg:text-2xl md:text-2xl text-2xl mr-5 mt-2 leading-tight 
