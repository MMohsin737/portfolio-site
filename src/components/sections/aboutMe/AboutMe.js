      ...
      <div className={`w-full flex 2xl:flex-row xl:flex-row lg:flex-row flex-col`}>
        ...
        >
          <p className={`text-lg leading-8 text-white`}>
            Innovative Front End Developer with 2 years experience building and maintaining responsive websites in the
            recruiting industry. Proficient in HTML, CSS, JavaScript, Dart, React and Flutter; plus modern libraries and
            frameworks. Passionate about usability and possess working knowledge of Adobe Photoshop & Figma. Experience
            has taught me to take accessibility and responsiveness seriously. I possess a positive “can-do” attitude
            where I am able to walk the extra mile in order to get the job done.
          </p>

          <div className={`p-3 mt-5 lg:mx-0 mx-auto`}>
            <CtaBtnV1 title="Download Resume" customStyle={``} onPressed={() => {}} />
          </div>
        </div>
      </div>
    </div>
